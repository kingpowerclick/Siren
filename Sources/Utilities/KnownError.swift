...
public enum KnownError: LocalizedError
{
    ...
    case performVersionCheckingFailed(underlyingError: Error)
    ...
    public var localizedDescription: String
    {
        switch self
        {
            ...
            case .recentlyPrompted:
                return "\(KnownError.sirenError) Siren will not present an update alert if it performed one too recently."
            ...
            case .performVersionCheckingFailed(_):
                return "Perform Version Checking Failed"
        }
    }
